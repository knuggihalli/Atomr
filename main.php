...
<div class="row">
  <div class="col-md-3">
       <div class="panel panel-info">
        ...
        <li><a href="/Atomr/environment">Migrate Environments&nbsp;&nbsp;&nbsp;&nbsp; <span class="glyphicon glyphicon-hdd"></span></a></li>
      </ul>
      <hr>
       <ul class="nav nav-stacked">
        ...
        <li><a href="migrateschedules.php">Environment Restoration&nbsp;&nbsp;&nbsp;&nbsp; <span class="glyphicon glyphicon-screenshot"></span></a></li>

      </ul>
      <hr>
      <ul class="nav nav-stacked">
        <li><a href="help.php">Atomr Help&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-share-alt"></span></a></li>
      </ul>
     ...
     for ($i=1; $i<$results+1 ; $i++) { 
                ...
                ?>
                  ...
                  <div class="panel-body">
                      ...
                      <p>Workflow is designed to simplify integration processes with Dell Boomi if you have any questions or concerns visit the help section under Migration Tools.</p>
                      <br>
                      <center><a href="#" class="btn btn-danger btn-md active" role="button">Report a Bug?</a></center>
                  </div>
        </div>
