   ...
   $_SESSION['val'] = 0;
                ...
                if (isset($_POST['process'])) {
                  foreach ($_POST['process'] as $process) {
                    ...
                    $atoms = get_all_atoms($_SESSION['account_id'],$_SESSION['auth'],$_SESSION['envstart']);
                    $atom = $atoms[1]['attributes']['ATOMID'];
                    $sch = get_all_schedules($_SESSION['account_id'],$_SESSION['auth'],$atom,$process);
                    $_SESSION['cid']=   $sch[1]['attributes']['ID'];
