...
if (isset($_SESSION['Environment'])) {
  $cmt2 = "It seems your are using enviroments please slect what Environments you want to migrate";
...
<div class="panel panel-info">
              ...
              <b><h4>Environment Migration</h4></b>
        
                      <p>You have started a Environment migration, this will move all processes & schedules across environments.</p>
