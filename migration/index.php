...
if (isset($_SESSION['Environment'])) {
  $cmt2 = "It seems your are using enviroments please slect what Environments you want to migrate Atoms from";
...
<div id="loginModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <center><h4><br>Atom Migration - Step 1</h4></center>
      <div class="modal-body">
          <p>Please begin by selecting your start point environment. This is the environment that will be queried for atom that can be moved to the end point you select in the next step.</p>
      </div>
